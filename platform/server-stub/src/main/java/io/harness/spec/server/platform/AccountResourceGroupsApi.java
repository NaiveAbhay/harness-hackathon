...
,  @QueryParam("account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.")  String account
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(operationId = "filterResourceGroupAcc", summary = "Filter Resource Groups", description = "Returns a filtered list of Resource Groups present in the Account scope.", security = {
        @SecurityRequirement(name = "x-api-key")    }, tags={ "Account Resource Groups" })
    @ApiResponses(value = { 
    ...
    Response filterResourceGroupAcc(@Valid FilterResourceGroupRequest body,  @QueryParam("account") 
...
,  @QueryParam("account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.")  String account
    ...
    @Path("/{resource-group}")
    @Produces({ "application/json" })
    @Operation(operationId = "getResourceGroupInternalAcc", summary = "Retrieve a Resource Group [Internal]", description = "Retrieves a Resource Group from Account scope. [Internal]", security = {
        @SecurityRequirement(name = "x-api-key")    }, tags={ "Account Resource Groups" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Resource Group Response", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResourceGroupsResponse.class))) })
    Response getResourceGroupInternalAcc( @PathParam("resource-group")
