...
public interface AccountRoleAssignmentsApi {

    @POST
    @Consumes({ "application/json", "application/yaml" })
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "createAccountScopedRoleAssignments", summary = "Create a role assignment", description = "Create a role assignment", tags={ "Account Role Assignments" })
    @ApiResponses(value = { 
    ...
    Response createAccountScopedRoleAssignments(@Valid RoleAssignment body,  @HeaderParam("Harness-Account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.") String harnessAccount
    ...
    @Path("/{roleassignment}")
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "deleteAccountScopedRoleAssignment", summary = "Delete a role assignment", description = "Deletes the information of the role assignment with the matching role assignment slug.", tags={ "Account Role Assignments" })
    @ApiResponses(value = { 
    ...
    Response deleteAccountScopedRoleAssignment( @PathParam("roleassignment")
...
,  @HeaderParam("Harness-Account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.") String harnessAccount
    ...
    @Path("/{roleassignment}")
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "getAccountScopedRoleAssignment", summary = "Retrieve a role assignment", description = "Retrieves the information of the role assignment with the matching role assignment slug.", tags={ "Account Role Assignments" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Role assignment response body", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RoleAssignmentResponse.class))) })
    Response getAccountScopedRoleAssignment( @PathParam("roleassignment")
...
,  @HeaderParam("Harness-Account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.") String harnessAccount
    ...
    @GET
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "getAccountScopedRoleAssignments", summary = "List role assignments", description = "Retrieves the information of the role assignments", tags={ "Account Role Assignments" })
    @ApiResponses(value = { 
    ...
    Response getAccountScopedRoleAssignments(  @HeaderParam("Harness-Account") 
