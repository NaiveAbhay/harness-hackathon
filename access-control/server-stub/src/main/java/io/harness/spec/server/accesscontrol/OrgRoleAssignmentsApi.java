...
@Path("/v1/orgs/{org}/roleassignments")


public interface OrgRoleAssignmentsApi {

    @POST
    @Consumes({ "application/json", "application/yaml" })
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "createOrgScopedRoleAssignments", summary = "Create a role assignment", description = "Create a role assignment", tags={ "Org Role Assignments" })
    @ApiResponses(value = { 
    ...
    Response createOrgScopedRoleAssignments(@Valid RoleAssignment body, @PathParam("org")
...
,  @HeaderParam("Harness-Account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.") String harnessAccount
    ...
    @Path("/{roleassignment}")
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "deleteOrgScopedRoleAssignment", summary = "Delete a role assignment", description = "Deletes the information of the role assignment with the matching role assignment slug.", tags={ "Org Role Assignments" })
    @ApiResponses(value = { 
    ...
    Response deleteOrgScopedRoleAssignment( @PathParam("roleassignment")
...
,  @HeaderParam("Harness-Account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.") String harnessAccount
    ...
    @Path("/{roleassignment}")
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "getOrgScopedRoleAssignment", summary = "Retrieve a role assignment", description = "Retrieves the information of the role assignment with the matching role assignment slug.", tags={ "Org Role Assignments" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Role assignment response body", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RoleAssignmentResponse.class))) })
    Response getOrgScopedRoleAssignment( @PathParam("roleassignment")
...
,  @HeaderParam("Harness-Account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.") String harnessAccount
    ...
    @GET
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "getOrgScopedRoleAssignments", summary = "List role assignments", description = "Retrieves the information of the role assignments", tags={ "Org Role Assignments" })
    @ApiResponses(value = { 
    ...
    Response getOrgScopedRoleAssignments( @PathParam("org")
