...
public interface AccountConnectorApi {
    ...
    Response createAccountScopedConnector(@Valid ConnectorRequest body,  @QueryParam("account") 
 ...
 @Parameter(description = "Slug field of the account the resource is scoped to. This is required for Authorization method other than x-api-key header. If you are using x-api-key header this can be skipped.")  String account
    ...
    @GET
    @Produces({ "application/json", "application/yaml" })
    @Operation(operationId = "getAccountScopedConnector", summary = "List connectors", description = "Retrieves the information of the connectors.", tags={ "Account Connector" })
    @ApiResponses(value = { 
    ...
    Response getAccountScopedConnector();}
