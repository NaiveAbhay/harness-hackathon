...
@Schema(description = "This contains details of the AWS connector and needs AWS encrypted access and secret keys for an AWS IAM user.")

public class AwsEncryptedAccessKeyConnectorSpec extends ConnectorSpec implements OneOfConnectorSpec  {
  ...
  @Schema(required = true, description = "Reference to encrypted Harness secret for AWS access key")
   ...
   **/
  public AwsEncryptedAccessKeyConnectorSpec crossAccountRoleArn(String crossAccountRoleArn) {
   ...
   **/
  public AwsEncryptedAccessKeyConnectorSpec delegateSelectors(List<String> delegateSelectors) {
   ...
   * execute on delegate
   **/
  public AwsEncryptedAccessKeyConnectorSpec executeOnDelegate(Boolean executeOnDelegate) {
  ...
  public boolean equals(Object o) {
    ...
    AwsEncryptedAccessKeyConnectorSpec awsEncryptedAccessKeyConnectorSpec = (AwsEncryptedAccessKeyConnectorSpec) o;
    return Objects.equals(accessKeyRef, awsEncryptedAccessKeyConnectorSpec.accessKeyRef) &&
        Objects.equals(secretKeyRef, awsEncryptedAccessKeyConnectorSpec.secretKeyRef) &&
        Objects.equals(crossAccountRoleArn, awsEncryptedAccessKeyConnectorSpec.crossAccountRoleArn) &&
        Objects.equals(externalId, awsEncryptedAccessKeyConnectorSpec.externalId) &&
        Objects.equals(testRegion, awsEncryptedAccessKeyConnectorSpec.testRegion) &&
        Objects.equals(delegateSelectors, awsEncryptedAccessKeyConnectorSpec.delegateSelectors) &&
        Objects.equals(executeOnDelegate, awsEncryptedAccessKeyConnectorSpec.executeOnDelegate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessKeyRef, secretKeyRef, crossAccountRoleArn, externalId, testRegion, delegateSelectors, executeOnDelegate);
  }
