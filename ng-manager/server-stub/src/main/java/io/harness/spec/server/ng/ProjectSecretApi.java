...
public interface ProjectSecretApi {
  ...
  @Operation(operationId = "createProjectScopedSecret",
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "deleteProjectScopedSecret", summary = "Delete a secret",
      description =
  ...
  @Path("/{secret}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getProjectScopedSecret",
  ...
  @GET
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getProjectScopedSecrets", summary = "List secrets",
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "updateProjectScopedSecret", summary = "Update a secret",
      description =
  ...
  @Path("/{secret}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "validateUniqueProjectScopedSecretSlug",
