...
public interface ProjectConnectorApi {
  ...
  @Path("/stats")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getProjectScopedConnectorsStatistics",
  ...
  Response
  getProjectScopedConnectorsStatistics(
      @PathParam("org")
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "testProjectScopedConnector", summary = "Test a connector",
      description =
  ...
  @Path("/{connector}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "validateUniqueProjectScopedConnectorSlug",
  ...
  Response
  validateUniqueProjectScopedConnectorSlug(
      @PathParam("org")
