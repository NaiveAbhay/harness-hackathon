...
public interface AccountSecretApi {
  ...
  @Operation(operationId = "createAccountScopedSecret",
             summary = "Create a secret", description = "Creates a new secret",
             security = { @SecurityRequirement(name = "x-api-key") },
             tags = {"Account Secret"})
  @ApiResponses(value =
                {
                  @ApiResponse(
                      responseCode = "201", description = "Secret response",
                      content =
  ...
  Response
  createAccountScopedSecret(
      @FormDataParam(value = "spec") SecretRequest spec,
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "deleteAccountScopedSecret", summary = "Deletes a secret",
      description =
  ...
  @ApiResponses(value =
                {
                  @ApiResponse(
                      responseCode = "200", description = "Secret response",
                      content =
                          @Content(mediaType = "application/json",
                                   schema = @Schema(implementation =
                                                        SecretResponse.class)))
  ...
  @Path("/{secret}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getAccountScopedSecret",
  ...
  @GET
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getAccountScopedSecrets", summary = "List secrets",
  ...
  @ApiResponses(
      ...
      {
        @ApiResponse(
            responseCode = "200", description = "Secret list response",
            content = @Content(
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "updateAccountScopedSecret", summary = "Update a secret",
      description =
  ...
  @Path("/{secret}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "validateUniqueAccountScopedSecretSlug",
  ...
  @ApiResponses(value =
                {
                  @ApiResponse(responseCode = "200",
                               description = "Validate secret slug response",
                               content = @Content(
                                   mediaType = "application/json",
                                   schema = @Schema(
                                       implementation =
                                           ValidateSecretSlugResponse.class)))
                })
  Response
