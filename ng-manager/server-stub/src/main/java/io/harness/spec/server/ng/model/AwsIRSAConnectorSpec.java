...
@Schema(description = "This contains details of the AWS connector. This uses IRSA and forces the Harness kubernetes delegate in AWS EKS to use a specific IAM role.")

public class AwsIRSAConnectorSpec extends ConnectorSpec implements OneOfConnectorSpec  {
   ...
   **/
  public AwsIRSAConnectorSpec delegateSelectors(List<String> delegateSelectors) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(crossAccountRoleArn, awsIRSAConnectorSpec.crossAccountRoleArn) &&
        Objects.equals(externalId, awsIRSAConnectorSpec.externalId) &&
        Objects.equals(testRegion, awsIRSAConnectorSpec.testRegion) &&
        Objects.equals(delegateSelectors, awsIRSAConnectorSpec.delegateSelectors) &&
        Objects.equals(executeOnDelegate, awsIRSAConnectorSpec.executeOnDelegate);
  }
