...
@Schema(description = "This contains details of the Azure connector for contains azure MSI auth details")

public class AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec extends ConnectorSpec implements OneOfConnectorSpec  {
...
public enum AzureEnvironmentTypeEnum {
   ...
   **/
  public AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec delegateSelectors(List<String> delegateSelectors) {
 ...
 @Size(min=1)
   ...
   **/
  public AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec azureEnvironmentType(AzureEnvironmentTypeEnum azureEnvironmentType) {
   ...
   * execute on delegate
   **/
  public AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec executeOnDelegate(Boolean executeOnDelegate) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec azureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec = (AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec) o;
    return Objects.equals(delegateSelectors, azureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec.delegateSelectors) &&
        Objects.equals(azureEnvironmentType, azureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec.azureEnvironmentType) &&
        Objects.equals(executeOnDelegate, azureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec.executeOnDelegate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delegateSelectors, azureEnvironmentType, executeOnDelegate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AzureInheritFromDelegateSystemAssignedManagedIdentityConnectorSpec {\n");
