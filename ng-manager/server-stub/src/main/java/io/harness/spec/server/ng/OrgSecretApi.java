...
public interface OrgSecretApi {
  ...
  @Operation(operationId = "createOrgScopedSecret", summary = "Create a secret",
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "deleteOrgScopedSecret", summary = "Delete a secret",
      description =
  ...
  @Path("/{secret}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getOrgScopedSecret", summary = "Retrieve a secret",
  ...
  @GET
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getOrgScopedSecrets", summary = "List secrets",
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "updateOrgScopedSecret", summary = "Update a secret",
      description =
  ...
  @Path("/{secret}")
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "validateUniqueOrgScopedSecretSlug",
