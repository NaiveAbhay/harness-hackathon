...
public class ConnectorResponse {
  ...
  /**
   * This indicates if this Connector is managed by Harness or not. If True,
   *Harness can manage and modify this Connector.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(connector, connectorResponse.connector) &&
        ...
        Objects.equals(governanceMetadata,
                       connectorResponse.governanceMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connector, created, updated, harnessManaged,
                        governanceMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("    harnessManaged: ")
        .append(toIndentedString(harnessManaged))
        .append("\n");
