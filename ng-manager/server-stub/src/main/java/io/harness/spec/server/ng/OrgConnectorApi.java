...
public interface OrgConnectorApi {
  ...
  @Operation(operationId = "createOrgScopedConnector",
  ...
  @Path("/{connector}")
  @Operation(
      operationId = "deleteOrgScopedConnector", summary = "Delete a connector",
      description =
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "getOrgScopedConnector", summary = "Retrieve a connector",
      description =
  ...
  @GET
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "getOrgScopedConnectors",
  ...
  @Produces({"application/json", "application/yaml"})
  @Operation(
      operationId = "updateOrgScopedConnector", summary = "Update a connector",
      description =
